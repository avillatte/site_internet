...
function validateField(field) {
    ...
    switch(field.type) {
        ...
        case 'tel':
            ...
            break;
        case 'chien':
            if (value && !isValidChien(value)) {
                isValid = false;
                errorMessage = "Veuillez entre la race de votre chien";
            }
...
// Validation de la race du chien
function isValidChien(chien){
    const chienRegex = '';
    return chienRegex.test(chien.replace(''));
}
